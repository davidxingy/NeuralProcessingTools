...
behvPlotOrder = [3 4 9 8 11 10 6 1 5 2]; %D041
behvColorOrder = [3 4 5 8 6 7 9 2 10 1];
...
plot(gridXInds(boundaryXs(inRegionInds)),gridYInds(boundaryYs(inRegionInds)),'k.','MarkerSize',4)
