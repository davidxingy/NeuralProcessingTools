        ...
        for iRegion2 = 1:nRegions
            if iRegion1 > iRegion2
                ...
                for iFold = 1:nFolds
                    ...
                    twoTrainEMGCent{iRegion1,iRegion2,iFold} = thisTwoTrainEMG - nanmean(thisTwoTrainEMG,2);
                    twoTrainBothCent{iRegion1,iRegion2,iFold} = thisTwoTrainBoth - nanmean(thisTwoTrainBoth,2);
                    twoTrainStrCent{iRegion1,iRegion2,iFold} = thisTwoTrainStr - nanmean(thisTwoTrainStr,2);
                    twoTrainCtxCent{iRegion1,iRegion2,iFold} = thisTwoTrainCtx - nanmean(thisTwoTrainCtx,2);

                    % linear weights
                    for iChan = 1:size(emgCent,1)
                        decoderWeightsTwoBoth{iRegion1,iRegion2,iFold}(iChan,:) = ridge(twoTrainEMGCent{iRegion1,iRegion2,iFold}(iChan,:)', twoTrainBothCent{iRegion1,iRegion2,iFold}', 0.1);
                        decoderWeightsTwoStr{iRegion1,iRegion2,iFold}(iChan,:) = ridge(twoTrainEMGCent{iRegion1,iRegion2,iFold}(iChan,:)', twoTrainStrCent{iRegion1,iRegion2,iFold}', 0.1);
                        decoderWeightsTwoCtx{iRegion1,iRegion2,iFold}(iChan,:) = ridge(twoTrainEMGCent{iRegion1,iRegion2,iFold}(iChan,:)', twoTrainCtxCent{iRegion1,iRegion2,iFold}', 0.1);
                    end
...
for iRegion = 1:nRegions
    ...
    if doCrossRegion
        ...
        for iRegion2 = 1:nRegions
            if iRegion2 == iRegion2
                continue
            end
            estEMGTwoBoth{iRegion,iRegion2} = cat(2,estTwoFoldsBoth{iRegion,iRegion2,:});
            estEMGTwoStr{iRegion,iRegion2} = cat(2,estTwoFoldsStr{iRegion,iRegion2,:});
            estEMGTwoCtx{iRegion,iRegion2} = cat(2,estTwoFoldsCtx{iRegion,iRegion2,:});
        end
