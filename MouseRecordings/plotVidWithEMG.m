...
saveGifButton = uibutton(mainFig,'push','Text','Save','Position',[720 60 50 20],...
...
loopButton = uibutton(mainFig,'state','Text','Loop','Position',[770 60 50 20],...
    'ValueChangedFcn', @(loopButton,event) loopButtonCallback(loopButton,mainFig));

setappdata(mainFig,'loopButton',loopButton);
